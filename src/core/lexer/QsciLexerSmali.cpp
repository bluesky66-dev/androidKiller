...
QsciLexerSmali::QsciLexerSmali(QObject *parent /*= 0*/, bool caseInsensitiveKeywords /*= false*/)
	: QsciLexer(parent)
{
...
// words.
QStringList QsciLexerSmali::autoCompletionWordSeparators() const
{
	QStringList wl;
...
const char *QsciLexerSmali::blockStartKeyword(int *style) const
{
	if (style)
		*style = Keyword;

	return "case catch class default do else finally for if private "
		"protected public struct try union while .method";
}
...
int QsciLexerSmali::braceStyle() const
{
	return Operator;
}
...
bool QsciLexerSmali::defaultEolFill(int style) const
{
	switch (style)
	{
		case UnclosedString:
...
const char *QsciLexerSmali::keywords(int set) const
{
	if (set == 1)
		...
		"virtual void volatile wchar_t while xor xor_eq invoke-direct";
...
QColor QsciLexerSmali::defaultPaper(int style) const
{
	switch (style)
	{
		case UnclosedString:
...
void QsciLexerSmali::setFoldAtElse(bool fold)
{
	fold_atelse = fold;
...
void QsciLexerSmali::setAtElseProp()
{
...
void QsciLexerSmali::setFoldPreprocessor(bool fold)
{
	fold_preproc = fold;
...
void QsciLexerSmali::setPreprocProp()
{
...
void QsciLexerSmali::setStylePreprocessor(bool style)
{
	style_preproc = style;
...
void QsciLexerSmali::setStylePreprocProp()
{
...
void QsciLexerSmali::setDollarsAllowed(bool allowed)
{
	dollars = allowed;
...
void QsciLexerSmali::setDollarsProp()
{
...
void QsciLexerSmali::setHighlightTripleQuotedStrings(bool enabled)
{
...
void QsciLexerSmali::setHighlightTripleProp()
{
...
void QsciLexerSmali::setHighlightHashQuotedStrings(bool enabled)
{
...
void QsciLexerSmali::setHighlightHashProp()
{
...
void QsciLexerSmali::setHighlightBackQuotedStrings(bool enabled)
{
...
void QsciLexerSmali::setHighlightBackProp()
{
...
void QsciLexerSmali::setHighlightEscapeSequences(bool enabled)
{
...
void QsciLexerSmali::setHighlightEscapeProp()
{
...
void QsciLexerSmali::setVerbatimStringEscapeSequencesAllowed(bool allowed)
{
	vs_escape = allowed;
...
void QsciLexerSmali::setVerbatimStringEscapeProp()
{
